...
brd_vue = {
	...
	brd_body: x=>{
		...
		'        <h6 class="border-bottom border-gray pb-2 mb-0">'+x.uid+'</h6>'+
	...
	brd_write: d=>{
		  ...
		  +'<form>'
		  +'<input type="text" name="writer" style="margin-top:20px" class="form-control" placeholder="아이디 : '+d.uid+', 이름 :'+d.uname+'" />'
